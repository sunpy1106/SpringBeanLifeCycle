 ...
 * @param <GroovyDynamicElementReader>
 * @since 4.0
 ...
 */
public class GroovyBeanDefinitionReader<GroovyDynamicElementReader> extends AbstractBeanDefinitionReader implements GroovyObject {
	...
	public Object invokeMethod(String name, Object arg) {
		...
		if ("beans".equals(name) && args.length == 1 && args[0] instanceof Closure) {
			...
			((GroovyObjectSupport) reader).invokeMethod("doCall", args);
		}
